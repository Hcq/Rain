...
<script runat="server">
    override protected void OnInit(EventArgs e)
    {
        ...
        */
        ...
        templateBuilder.Append("/templates/webhtml");
        templateBuilder.Append("/css/lightbox.css\" rel=\"stylesheet\">\r\n<script src=\"");
        templateBuilder.Append("/templates/webhtml");
        templateBuilder.Append("/js/lightbox.js\"></");
        ...
        templateBuilder.Append(get_prevandnext_article("goods_show", -1, "没有了", 0).ToString());

        templateBuilder.Append("</span><span\r\n                            class=\"to_next col-xs-12 col-sm-6 col-md-6\">下一个：");
        templateBuilder.Append(get_prevandnext_article("goods_show", 1, "没有了", 0).ToString());

        templateBuilder.Append("</span></div>\r\n        </div>\r\n        \r\n      </div>\r\n      <!-- end right-->\r\n      <!-- left -->\r\n      <div class=\"col-xs-12 col-sm-4 col-md-3\" id=\"categories\">\r\n        <div class=\"left_nav\">\r\n\r\n          <h2 class=\"pro_h2\">导航栏目</h2>\r\n          <ul class=\"left_nav_ul\" id=\"firstpane\">\r\n            ");
        DataTable categoryList1 = get_category_child_list(channel, 55);
