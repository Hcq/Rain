<%@ Page Language="C#" AutoEventWireup="true" Inherits="Rain.Web.UI.Page.search" ValidateRequest="false" %>
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        */
        ...
        foreach (DataRow dr in list.Rows)
        {
            ...
            templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a><span\r\n                            class=\"news_time\">"); templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(dr["add_time"])).ToString("yyyy-MM-dd"));
        ...
        templateBuilder.Append("</div>\r\n        </div>\r\n      </div>\r\n      <!-- end right-->\r\n      <!-- left -->\r\n      <div class=\"col-xs-12 col-sm-4 col-md-3\">\r\n        <div class=\"left_nav\" id=\"categories\">\r\n\r\n          <h2 class=\"pro_h2\">导航栏目</h2>\r\n          <ul class=\"left_nav_ul\" id=\"firstpane\">\r\n            <li><a class=\"biglink\" href=\"#\">站内搜索</a><span class=\"menu_head\">+</span>\r\n              <ul class=\"left_snav_ul menu_body\">\r\n              </ul>\r\n            </li>\r\n          </ul>\r\n        </div>\r\n          <!-- left -->\r\n        ");
