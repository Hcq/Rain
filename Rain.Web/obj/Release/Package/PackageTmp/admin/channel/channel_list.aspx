<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="channel_list.aspx.cs" Inherits="Rain.Web.admin.channel.channel_list" %>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><%#Eval("name")%></td>
      <td><%#Eval("title")%></td>
      <td><%#new Rain.BLL.channel_site().GetTitle(Convert.ToInt32(Eval("site_id")))%></td>
