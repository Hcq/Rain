<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="center.aspx.cs" Inherits="Rain.Web.admin.center" %>
...
<div class="nlist-1"  style="color:#FF0000">
  <ul>
    <li></li>
  </ul>
</div>
...
<div class="nlist-2">
  ...
  <ul>
    ...
    <li>升级通知：<li>升级通知：<asp:Literal ID="LitUpgrade" runat="server"/></li></li>
  </ul>
</div>
