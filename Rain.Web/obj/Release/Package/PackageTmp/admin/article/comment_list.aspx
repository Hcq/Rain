<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_list.aspx.cs" Inherits="Rain.Web.admin.article.comment_list" %>
    ...
    <tr>
      <td class="comment">
        <div class="title">
          ...
          <%#new Rain.BLL.article().GetTitle(Convert.ToInt32(Eval("article_id")))%>
        </div>
        <div class="ask">
