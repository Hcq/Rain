<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_edit.aspx.cs" Inherits="Rain.Web.admin.order.order_edit" ValidateRequest="false" %>
  ...
  <dl>
    ...
    <dd>
      <div class="table-container">
        ...
        <tr>
          <th width="20%">支付方式</th>
          <td><%=new Rain.BLL.payment().GetTitle(model.payment_id) %></td>
        </tr>
        <tr>
          <th>配送方式</th>
          <td><%=new Rain.BLL.express().GetTitle(model.express_id) %></td>
        </tr>
        <tr>
          <th>是否开具发票</th>
