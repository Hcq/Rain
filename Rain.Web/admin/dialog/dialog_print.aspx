<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_print.aspx.cs" Inherits="Rain.Web.admin.dialog.dialog_print" %>
...
<tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin:5px auto; font-size:12px; font-family:'微软雅黑'; background:#fff;">
    ...
    <tr>
      <td valign="top">支付方式：<%=new Rain.BLL.payment().GetTitle(model.payment_id) %></td>
      <td valign="top">手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 机：<%=model.mobile%></td>
    </tr>
    <tr>
      <td>配送方式：<%=new Rain.BLL.express().GetTitle(model.express_id)%></td>
