...
// Type: Rain.Web.admin.users.sms_template_list
...
{
  public class sms_template_list : ManagePage
  {
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
      ...
      this.rptList.DataSource = (object) new sms_template().GetList(this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
      this.rptList.DataBind();
      this.txtPageNum.Text = this.pageSize.ToString();
      this.PageContent.InnerHtml = Utils.OutPageList(this.pageSize, this.page, this.totalCount, Utils.CombUrlTxt("sms_template_list.aspx", "keywords={0}&page={1}", this.keywords, "__id__"), 8);
    }
    ...
    protected string CombSqlTxt(string _keywords)
    {
      ...
      if (!string.IsNullOrEmpty(_keywords))
        stringBuilder.Append(" and (title like  '%" + _keywords + "%' or content like '%" + _keywords + "%')");
    ...
    {
      int result;
      if (int.TryParse(Utils.GetCookie("sms_template_page_size", "UScmsPage"), out result) && result > 0)
        return result;
    ...
    {
      this.Response.Redirect(Utils.CombUrlTxt("sms_template_list.aspx", "keywords={0}", this.txtKeywords.Text));
    }
    ...
    protected void txtPageNum_TextChanged(object sender, EventArgs e)
    {
      ...
      if (int.TryParse(this.txtPageNum.Text.Trim(), out result) && result > 0)
        Utils.WriteCookie("sms_template_page_size", "UScmsPage", result.ToString(), 14400);
      this.Response.Redirect(Utils.CombUrlTxt("sms_template_list.aspx", "keywords={0}", this.keywords));
    }
