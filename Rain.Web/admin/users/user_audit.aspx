<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_audit.aspx.cs" Inherits="Rain.Web.admin.users.user_audit" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Rain.BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
