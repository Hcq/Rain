<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_edit.aspx.cs" Inherits="Rain.Web.admin.article.comment_edit" ValidateRequest="false" %>
...
<div class="tab-content">
  <dl>
    <dt>信息标题</dt>
    <dd><%=new Rain.BLL.article().GetTitle(model.article_id)%></dd>
  </dl>
  <dl>
    <dt>评论用户</dt>
