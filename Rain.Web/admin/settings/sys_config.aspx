<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="Rain.Web.admin.settings.sys_config" ValidateRequest="false" %>
...
<div class="tab-content" style="display:none">
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">尚未申请？<a href="http://sms.uscms.net" target="_blank">请点击这里注册</a></span>
    </dd>
  </dl>
  <dl>
    <dt>短信API地址</dt>
  ...
  <dl>
    ...
    <dd>
      ...
      如果您尚未申请开通，<a href="http://sms.uscms.net" target="_blank">请点击这里注册</a>成功后填写您的用户名和密码均可正常使用。
    </dd>
  </dl>
</div>
<!--/手机短信设置-->
