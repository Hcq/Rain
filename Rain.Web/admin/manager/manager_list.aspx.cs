...
// Type: Rain.Web.admin.manager.manager_list
...
{
  public class manager_list : ManagePage
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (this.Page.IsPostBack)
        return;
      this.ChkAdminLevel(nameof (manager_list), DTEnums.ActionEnum.View.ToString());
      this.RptBind("role_type>=" + (object) this.GetAdminInfo().role_type + this.CombSqlTxt(this.keywords), "add_time asc,id desc");
    }
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
      ...
      this.rptList.DataSource = (object) new Rain.BLL.manager().GetList(this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
      this.rptList.DataBind();
      this.txtPageNum.Text = this.pageSize.ToString();
      this.PageContent.InnerHtml = Utils.OutPageList(this.pageSize, this.page, this.totalCount, Utils.CombUrlTxt("manager_list.aspx", "keywords={0}&page={1}", this.keywords, "__id__"), 8);
    }
    ...
    protected string CombSqlTxt(string _keywords)
    {
      ...
      if (!string.IsNullOrEmpty(_keywords))
        stringBuilder.Append(" and (user_name like  '%" + _keywords + "%' or real_name like '%" + _keywords + "%' or email like '%" + _keywords + "%')");
    ...
    {
      this.Response.Redirect(Utils.CombUrlTxt("manager_list.aspx", "keywords={0}", this.txtKeywords.Text));
    }
    ...
    protected void txtPageNum_TextChanged(object sender, EventArgs e)
    {
      ...
      this.Response.Redirect(Utils.CombUrlTxt("manager_list.aspx", "keywords={0}", this.keywords));
    }
