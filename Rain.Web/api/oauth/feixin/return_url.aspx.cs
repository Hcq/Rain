...
// Type: Rain.Web.api.oauth.feixin.return_url
...
namespace Rain.Web.api.oauth.feixin
{
  public class return_url : Page
  {
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      {
        Dictionary<string, object> accessToken = feixin_helper.get_access_token(queryString2);
        ...
        else
        {
          ...
          {
            string str = info["userId"].ToString();
            this.Session["oauth_name"] = (object) "feixin";
