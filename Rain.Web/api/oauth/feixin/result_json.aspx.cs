...
// Type: Rain.Web.api.oauth.feixin.result_json
  ...
  public class result_json : Page
  {
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      else
      {
        ...
        Dictionary<string, object> info = feixin_helper.get_info(access_token);
        if (info == null)
        {
        ...
        else
        {
          ...
          stringBuilder.Append("\"oauth_openid\": \"" + info["userId"].ToString() + "\", ");
          stringBuilder.Append("\"nick\": \"" + info["nickname"].ToString() + "\", ");
          stringBuilder.Append("\"avatar\": \"" + info["portraitLarge"].ToString() + "\", ");
          if (info["gender"].ToString() == "1")
            stringBuilder.Append("\"sex\": \"男\", ");
          else if (info["gender"].ToString() == "2")
