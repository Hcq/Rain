...
// Type: Rain.Web.api.oauth.renren.result_json
  ...
  public class result_json : Page
  {
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      else
      {
        ...
        Dictionary<string, object> info = renren_helper.get_info(access_token, "uid,name,sex,birthday,mainurl");
        if (info == null)
        {
        ...
        else
        {
          ...
          stringBuilder.Append("\"avatar\": \"" + info["mainurl"].ToString() + "\", ");
          if (info["sex"].ToString() == "1")
            stringBuilder.Append("\"sex\": \"男\", ");
          else if (info["sex"].ToString() == "0")
