...
// Type: Rain.Web.api.oauth.taobao.result_json
  ...
  public class result_json : Page
  {
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      else
      {
        ...
        Dictionary<string, object> info = taobao_helper.get_info(access_token, "user_id,nick,avatar,sex");
        if (info == null)
        {
        ...
        else
        {
          ...
          stringBuilder.Append("\"oauth_openid\": \"" + info["user_id"].ToString() + "\", ");
          stringBuilder.Append("\"nick\": \"" + info["nick"].ToString() + "\", ");
          stringBuilder.Append("\"avatar\": \"" + info["avatar"].ToString() + "\", ");
          if (info["sex"].ToString() == "m")
            stringBuilder.Append("\"sex\": \"男\", ");
          else if (info["sex"].ToString() == "f")
