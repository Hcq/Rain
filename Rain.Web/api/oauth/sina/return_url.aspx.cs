...
// Type: Rain.Web.api.oauth.sina.return_url
...
namespace Rain.Web.api.oauth.sina
{
  public class return_url : Page
  {
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      {
        Dictionary<string, object> accessToken = sina_helper.get_access_token(queryString2);
        ...
        else
        {
          ...
          string str2 = accessToken["uid"].ToString();
          this.Session["oauth_name"] = (object) "sina";
